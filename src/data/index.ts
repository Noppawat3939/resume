...
export const works: {
...
}[] = [
  {
    ...
    tasks: [
      ...
      "Developed a Service-Center backend system from scratch building APIs for repair orders, quotations, invoices, receive payments, and inventory using NestJS, TypeORM, and PostgreSQL.",
